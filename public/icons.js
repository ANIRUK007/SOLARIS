...
(function (root) {
  ...
  const PATHS = {
    ...
    'eye-off': '<path d="M9.9 6.1A8.5 8.5 0 0 1 12 5.8c6.2 0 9.8 6.2 9.8 6.2a17 17 0 0 1-3 3.7"/><path d="M6.3 8.1A17 17 0 0 0 2.2 12S5.8 18.2 12 18.2a8.7 8.7 0 0 0 3.6-.76"/><path d="M9.8 9.9a3.1 3.1 0 0 0 4.3 4.3"/><path d="M3.6 3.6l16.8 16.8"/>',
